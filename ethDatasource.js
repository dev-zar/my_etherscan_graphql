const { RESTDataSource } = require("apollo-datasource-rest");        // Import REST Data Source
...
class EtherDataSource extends RESTDataSource {
  ...
  async etherBalanceByAddress() {         // Query to get ether balance
    return this.get(
  ...
  async getBlockConfirmationTime() {          //Get block confirmation time
    return this.get(
